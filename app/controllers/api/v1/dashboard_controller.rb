...
class Api::V1::DashboardController < ApplicationController
  def index
    ...
    render json: { items_in_stock_count:, items_out_of_stock_count:, number_of_orders:, total_sales:, fastest_moving_items:, slowest_moving_items:, monthly_order_statistics:, daily_sales:, weekly_revenue:, monthly_revenue: }
  end
end
